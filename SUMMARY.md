...
* [4. 在数据库中创建一条数据](chapters/4.md)
* [5. 简单的用户认证](chapters/5.md)
* [6. 修改 User model](chapters/6.md)
* [7. User model 的 getter 方法](chapters/7.md)
* [8. view 的更多知识](chapters/8.md)
* [9. 在 view 中共享变量](chapters/9.md)
* [10. blade layout](chapters/10.md)
* [11. 使用 @include 来整理 view](chapters/11.md)
...
* [19. CURD 实践之为新添加的属性修改注册功能](chapters/19.md)
* [20. CURD 实践之用 username 来代替 email 登录](chapters/20.md)
* [21. CURD 个人中心页面](chapters/21.md)
